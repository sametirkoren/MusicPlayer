...
import {
    SetSelectedPlaylist, SetSelectedPlaylistForEdit,
    SetUser
...
function Playlists() {
    ...
    const { user, allSongs, selectedPlaylist, selectedSongs } = useSelector(
        (state) => state.user
    );
    const allPlylists = [
        {
                        ...
                        >
                            ...
                            <div className="flex gap-3 justify-between">
                                ...
                                <i className="ri-pencil-line text-2xl text-gray-500" onClick={() => {
                                    ...
                                    navigate(`/create-edit-playlist/?name=${playlist?.name}`)
                                }}></i>
                            </div>
                        </div>
                    );
